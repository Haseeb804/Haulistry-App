...
from . import bookings, vehicles, auth, services, fare_offers, locations, feedback, calls, messages, notifications, recommendations, providers_explore
...
api_router.include_router(providers_explore.router, prefix="/providers/explore", tags=["providers-explore"])
